...
public class SectionsAdapter extends RecyclerView.Adapter<GroupedArticleViewHolder> {
    ...
    @Override
    public GroupedArticleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(GroupedArticleViewHolder holder, int position) {
