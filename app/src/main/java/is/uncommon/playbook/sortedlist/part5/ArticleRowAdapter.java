...
public class ArticleRowAdapter extends RecyclerView.Adapter<AbstractArticleRowViewHolder> {
    ...
    @Override
    public AbstractArticleRowViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(AbstractArticleRowViewHolder holder, int position) {
